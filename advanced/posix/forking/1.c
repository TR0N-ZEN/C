...
int main ()
{
  ...
  //    from the line where fork() was called until the end of the block
  //    once executed in the parent process and once in the child process, these
  //    processes run independent from each other, none waits for the other in an way
